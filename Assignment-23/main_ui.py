...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(780, 554)
        MainWindow.setMinimumSize(QSize(780, 554))
        MainWindow.setMaximumSize(QSize(780, 554))
        ...
        self.line.setGeometry(QRect(260, 10, 16, 541))
        self.line.setAutoFillBackground(False)
        self.line.setFrameShape(QFrame.VLine)
        self.line.setFrameShadow(QFrame.Sunken)
        self.line_2 = QFrame(self.centralwidget)
        self.line_2.setObjectName(u"line_2")
        self.line_2.setGeometry(QRect(500, 10, 16, 541))
        ...
        self.menuDarkMode = QMenu(self.menuGame)
        ...
        self.menuGame.addAction(self.menuDarkMode.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuDarkMode.setTitle(QCoreApplication.translate("MainWindow", u"Light Mode", None))
    # retranslateUi
