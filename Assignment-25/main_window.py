...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ir_time_2 = QLabel(self.tab)
        self.ir_time_2.setObjectName(u"ir_time_2")
        self.ir_time_2.setGeometry(QRect(340, 30, 161, 41))
        font1 = QFont()
        font1.setFamilies([u"Seven Segment"])
        font1.setPointSize(20)
        self.ir_time_2.setFont(font1)
        self.ir_time_2.setStyleSheet(u"color: rgb(255, 0, 127);")
        self.ir_time_2.setAlignment(Qt.AlignCenter)
        self.ir_time_3 = QLabel(self.tab)
        self.ir_time_3.setObjectName(u"ir_time_3")
        self.ir_time_3.setGeometry(QRect(340, 150, 161, 41))
        self.ir_time_3.setFont(font1)
        self.ir_time_3.setStyleSheet(u"color: rgb(255, 0, 127);")
        self.ir_time_3.setAlignment(Qt.AlignCenter)
        self.ir_time_4 = QLabel(self.tab)
        self.ir_time_4.setObjectName(u"ir_time_4")
        self.ir_time_4.setGeometry(QRect(340, 270, 161, 41))
        self.ir_time_4.setFont(font1)
        self.ir_time_4.setStyleSheet(u"color: rgb(255, 0, 127);")
        self.ir_time_4.setAlignment(Qt.AlignCenter)
...
"background-color: rgb(240, 240, 240);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ir_time_2.setText(QCoreApplication.translate("MainWindow", u"+4:30", None))
        self.ir_time_3.setText(QCoreApplication.translate("MainWindow", u"+2:00", None))
        self.ir_time_4.setText(QCoreApplication.translate("MainWindow", u"-4:00", None))
